						...
						<div class="card" style="width: 55rem; height: 25rem;">
							...
							<div class="card-body">
								...
								<form id="statement-from" method="POST">
									From <input type="date" id="start_date" name="startDate">
									To <input type="date" id="end_date" name="endDate"> <input
										type="submit" class="btn" name="button_ok">
								</form>
								<div class="scroller">
									<table class="table">
										<thead>
										...
										if (request.getParameter("button_ok") != null) {
											try {
												...
												ResultSet rs = st
												.executeQuery("select * from transactions where txndate between '" + start + "' and '" + end + "'");
												while (rs.next()) {
										%>
